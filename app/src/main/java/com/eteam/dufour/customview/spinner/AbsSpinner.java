...
//                style, defStyle, 0);
//
//        CharSequence[] entries = a.getTextArray(android.R.attr.entries);
//        if (entries != null) {
//            ArrayAdapter<CharSequence> adapter =
//                    new ArrayAdapter<CharSequence>(context,
//                            android.R.attr.entries, entries);
...
//        a.recycle();
    ...
    public void setSelectionWithoutFiring(int position,long rowId){
    	mOldSelectedPosition = position;
    	mOldSelectedRowId = rowId;
