...
public class ElahSpinner extends AbsSpinner implements OnClickListener {
     ...
     */
    public ElahSpinner(Context context) {
        this(context, null);
    }
     ...
     * @see #MODE_DROPDOWN
     */
    public ElahSpinner(Context context, int mode) {
     ...
     */
    public ElahSpinner(Context context, AttributeSet attrs) {
     ...
     */
    public ElahSpinner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ElahSpinner(Context context, AttributeSet attrs, int defStyle, int mode) {
        super(context, attrs, defStyle);

//        TypedArray a = context.obtainStyledAttributes(attrs,
//                spinnerStyle, defStyle, 0);
//
//        if (mode == MODE_THEME) {
//            mode = a.getInt(android.R.attr.spinnerMode, MODE_DIALOG);
//        }
//        
        switch (mode) {
	        case MODE_DIALOG: {
...
//                    android.R.attr.dropDownVerticalOffset, 0);
//            if (verticalOffset != 0) {
//                popup.setVerticalOffset(verticalOffset);
//            }
//
//            final int horizontalOffset = a.getDimensionPixelOffset(
//                    android.R.attr.dropDownHorizontalOffset, 0);
...
//        
//        mGravity = a.getInt(android.R.attr.gravity, Gravity.CENTER);
//
//        mPopup.setPromptText(a.getString(android.R.attr.prompt));
//
//        mDisableChildrenWhenDisabled = a.getBoolean(
//                android.R.attr.enabled, false);
//
//        a.recycle();
//
...
//        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(ElahSpinner.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(ElahSpinner.class.getName());
    }
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            ...
            setAnchorView(ElahSpinner.this);
            setModal(true);
        ...
        public void show() {
            ...
            final int spinnerPaddingLeft = ElahSpinner.this.getPaddingLeft();
            final int spinnerPaddingRight = ElahSpinner.this.getPaddingRight();
            final int spinnerWidth = ElahSpinner.this.getWidth();
            ...
            setSelection(ElahSpinner.this.getSelectedItemPosition());
        ...
        private android.widget.AdapterView.OnItemClickListener listener = new android.widget.AdapterView.OnItemClickListener() {
			...
			public void onItemClick(android.widget.AdapterView<?> parent,
				...
				// TODO Auto-generated method stub
				ElahSpinner.this.setSelection(position);
                if (mOnItemClickListener != null) {
                    ElahSpinner.this.performItemClick(v, position, mAdapter.getItemId(position));
                }
                dismiss();
			}
    	};
